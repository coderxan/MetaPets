...
/// <summary>
/// UsesSpawnerHome true causes normal behavior, while false will cause the spawner to set the mobile's 
/// home to be its spawn location, thus, not walking back to the spawner.  This will create a less 
/// artificial feel to mobiles attempting to return to their home location.
/// 
/// Also, the spawn area and home range work together.  If the area is not set, they will behave pretty 
/// much like they always have.  If the area is set, the mobile will spawn within that rectangle. If both 
/// are set, the spawn location will be based on the rectangle and allow an additional # of tiles, which 
/// is the home range.
/// 
/// Also, since the home does not necessarily equate to the spawner location any longer, a gettersetter 
/// was added to the BaseCreature.
/// </summary>
