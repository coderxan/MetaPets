...
{
    public class StealableSpawner : Item
    {
        ...
        public static StealableSpawner Instance { get { return m_Instance; } }
        ...
        public StealableSpawner(Serial serial)
            : base(serial)
        {
            m_Instance = this;
        }
