...
namespace Server.Misc
{
    public class CharacterCreation
    {
        ...
        private static void FillBankAOS(Mobile m)
        {
            ...
            Item toHue = new BagOfMageryReagents(150);
            toHue.Hue = 0x2D;
            PlaceItemIn(cont, 45, 150, toHue);

            toHue = new BagOfNecromancyReagents(150);
            toHue.Hue = 0x488;
        ...
        private static void FillBankbox(Mobile m)
        {
            ...
            bank.DropItem(new BagOfMageryReagents(50));
        ...
        private static void SetSkills(Mobile m, SkillNameValue[] skills, int prof)
        {
            ...
            switch (prof)
            {
                ...
                case 4: // Necromancer
                    {
                        Container regs = new BagOfNecromancyReagents(50);
        ...
        private static void AddSkillItems(SkillName skill, Mobile m)
        {
            ...
            switch (skill)
            {
                ...
                case SkillName.Magery:
                    {
                        BagOfMageryReagents regs = new BagOfMageryReagents(30);
                ...
                case SkillName.Necromancy:
                    {
                        if (Core.ML)
                        {
                            Container regs = new BagOfNecromancerReagents(50);
